        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View>
                    ...
                    <TouchableOpacity style={[styles.itemcontainer,{backgroundColor:'red',marginTop:20,justifyContent:'center'}]}>  
                        <Text style={{color:'#fff',fontSize:16,fontWeight:'bold'}}>退出登录</Text>
                    </TouchableOpacity>
                </View>
